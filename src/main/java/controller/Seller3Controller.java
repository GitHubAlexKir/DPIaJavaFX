...
public class Seller3Controller {
    ...
    private MessageReceiverGateway receiver = new MessageReceiverGateway("Seller3Request");
    ...
    public Seller3Controller() throws NamingException, JMSException {
